SHELL = cmd.exe
export AS_PLC := X20CP1486
export AS_TEMP_PLC := X20CP1486
export AS_CPU_PATH := $(AS_TEMP_PATH)/Objects/$(AS_CONFIGURATION)/$(AS_PLC)
export AS_CPU_PATH_2 := C:/projects/Stabilizacja_ukladu_statek/ProjektGrupowy_git/Projekt/Kadlub/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_CPU_PATH)/Ship.br \
$(AS_CPU_PATH)/GUIShi.br \
vcPostBuild_GUIShi \
$(AS_CPU_PATH)/GUISh1.br \
vcPostBuild_GUISh1 \
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	...
	@'$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe' '$(AS_PROJECT_PATH)/Kadlub.apj' -t '$(AS_TEMP_PATH)' -o '$(AS_BINARIES_PATH)' -c '$(AS_CONFIGURATION)' -i 'C:/BrAutomation/AS43' -S 'X20CP1486'   -A 'X20CP1486' -pil   -swFiles '$(AS_PROJECT_PATH)/Physical/CP1486/X20CP1486/Cpu.sw' -Z 'Acp10Arnc0: 3.18.2, mapp: 1.62.1, UnitSystem: n.d, TextSystem: n.d, Connectivity: n.d, AAS: n.d' -C '/RT=1000 /AM=* /SDT=5 /DAIP=82.145.73.130 /REPO=11159 /ANSL=1 /PT=11169' -D '/IF=tcpip /LOPO=11159 /SA=80' -M IA32 -T SG4

#nothing to do (just call module make files)

include $(AS_CPU_PATH)/iomap/iomap.mak
include $(AS_CPU_PATH)/GUISh1/GUISh1.mak
include $(AS_CPU_PATH)/GUIShi/GUIShi.mak
include $(AS_CPU_PATH)/Ship/Ship.mak
